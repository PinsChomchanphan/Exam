...
{
    public class GetTransactionQueryHandler : IRequestHandler<GetTransactionQuery, IEnumerable<TransactionDto>>
    {
        private readonly IExamDatabaseDbContext _context;
        private readonly IMapper _mapper;
        public GetTransactionQueryHandler(IExamDatabaseDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
